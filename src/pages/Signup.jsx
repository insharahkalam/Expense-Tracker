...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center p-5 bg-gray-50 justify-center">
            <div className="w-full shadow-lg transition duration-500  max-w-xl bg-white p-5 rounded-3xl border border-gray-200">
